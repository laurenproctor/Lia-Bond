-- Add audit event vocabulary for rule execution (G1).
--
...
--
-- The three new literals below (`automation_rule.executed`,
-- `automation_rule.execution_failed`, `automation_sweep.completed`) are
-- written by the G1 execution functions; nothing writes them until those land.
